            ...
            <section>
                <div>
                    ...
                    <section className="card-container flex space-around">
                        ...
                        <Card style={{ backgroundColor: "#409EFF", height: "auto" }}>
                            <Card.Header>   Business Gold- <span>מתאים לחברה בע"מ</span></Card.Header>
                            <ListGroup className="maslul2" variant="flush">
                                ...
                                <ListGroup.Item>
                                    חשבות שכר לעובדים עד 5 עובדים ( תוספת תשלום עבור כל תלוש נוסף)
                                   </ListGroup.Item>
                                <ListGroup.Item>
                                    צילום וקליטת חשבוניות הוצאה דרך המחשב וטלפון נייד
                                   </ListGroup.Item>
                                <ListGroup.Item>
                                    דו"ח רווח והפסד תקופתיים
                                   </ListGroup.Item>
                                <ListGroup.Item>
                                    יצוא תנועות יומן בקובץ מותאם לתוכנות הנה"ח אחרות                                                                      </ListGroup.Item>
                                ...
                                <ListGroup.Item>
                                    אפשרות להדפסת שיקים לספקים                                </ListGroup.Item>
                                <ListGroup.Item>
                                    התאמות ספקים                                                                      </ListGroup.Item>
                                <ListGroup.Item>
                                    התאמות כרטיסי אשראי                                                                     </ListGroup.Item>
                                <ListGroup.Item>
                                    העברת החומר לביקורת                                                                      </ListGroup.Item>
                                <ListGroup.Item>
                                    אפשרות לביקורת לא כלול                                                                   </ListGroup.Item>

                            </ListGroup>
                            <Card.Body id="des" >
                                <Card.Link className="price"> <span>רק</span> 1000 ₪ לחודש (לא כולל מע"מ) </Card.Link>
                            </Card.Body>
                            <Card.Body id="maslul-link">
                                <Card.Link href="https://ez.finbot.co.il/hs-user/">להצטרפות לחץ כאן</Card.Link>
                            </Card.Body>
                        </Card>

                        <Card style={{ backgroundColor: "#E6A23C", height: "auto" }}>
                            <Card.Header>    Association Gold - <span> חבילת עמותות</span></Card.Header>
                            <ListGroup className="maslul2" variant="flush">
                                <ListGroup.Item>הפקת חשבונית ירוקה און ליין ללא הגבלת מסמכים</ListGroup.Item>
                                <ListGroup.Item>סליקה בכרטיס אשראי במחירים זולים</ListGroup.Item>
                                <ListGroup.Item>
                                ...
                                <ListGroup.Item>דיווח ותשלומים למע"מ</ListGroup.Item>
                                <ListGroup.Item>
                                    התראה לפי התשלומים</ListGroup.Item>
                            ...
                            <Card.Body id="des" >
                                <Card.Link className="price"> <span>רק</span> 700 ₪ לחודש (לא כולל מע"מ) </Card.Link>
                            </Card.Body>
                            <Card.Body id="maslul-link">
